...
export const Button = ({ children, disabled = false, size = "md", variant = "primary", className }: IButtonProps) => {
  ...
  return (
    <button type="button" className={buttonClasses} disabled={disabled} aria-disabled={disabled}>
      {children}
    </button>
  );
};
